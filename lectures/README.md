...
* [Class types](classes)
* [Loops, containers, and iterators](loops-containers)
* [Managing resources](resources)
* [Templates for generic programming](templates)
* [Algorithms and lambdas](algorithms-lambdas)
* [Linear algebra with Eigen](eigen)
