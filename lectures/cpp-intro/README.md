...
Next one, in 2023, well underway. Major features likely to include
networking, string formating, executors, and consolidation of new
C++20 features
...
You can use your laptop, Cirrus, or ARCHER2

__Your machine__ : you need a C++ compiler that supports at least
C++17. If you use Windows and MSVC we may not be able to help
much... Sorry!
