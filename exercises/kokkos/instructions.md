...
The files for this are on [the course repository](https://github.com/EPCCed/APT-CPP).

To check out the repository run:

```bash
git clone https://github.com/EPCCed/APT-CPP
cd APT-CPP/exercies/kokkos
```
...
`APT-CPP/exercies/kokkos/1/exercise_1_begin.cpp`
...
`APT-CPP/exercies/kokkos/2/exercise_2_begin.cpp`.
...
The corresponding source code is in
`APT-CPP/exercies/kokkos/3/exercise_3_begin.cpp`.
...
The corresponding source code is in
`APT-CPP/exercies/kokkos/4/exercise_4_begin.cpp`.
